...
import controlador.EventoVentanaRegParticipante;
 ...
 * @author DavidMorales
 */
public class VentanaRegParticipante extends JInternalFrame {
    ...
    public VentanaRegParticipante(GestionDato gD) {
        super("Registrar Participante",true,true,true,true);
        this.gD=gD;
    ...
    public void iniciaComponente(){
        ...
        this.datos = this.cargaDatosTabla(this.gD.getParticipanteList().size(), 4);
        ...
        this.boton.addActionListener(new EventoVentanaRegParticipante(this));
